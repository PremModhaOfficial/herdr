...
use super::targets::{
    ...
    install_grok, install_hermes, install_jcode, install_kilo, install_kimi, install_mastracode,
    ...
    uninstall_hermes, uninstall_jcode, uninstall_kilo, uninstall_kimi, uninstall_mastracode,
    ...
    let mut messages = match target {
        ...
        crate::api::schema::IntegrationTarget::Jcode => {
            ...
            vec![
                ...
                format!("wired jcode hooks in {}", installed.config_path.display()),
            ]
        }
    };
